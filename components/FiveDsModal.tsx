...
const STEPS = [
  ...
  },
  {
    ...
    title: "Distance yourself from the trigger",
    body: "Your surroundings may be feeding the craving. Change your environment — step outside, move to a different room, or take a short walk. A new setting resets your brain's craving signal.",
    cta: "I changed my environment ✓",
  },
];
...
export default function FiveDsModal({ open, onClose, cravingId, onMarkResisted }: FiveDsModalProps) {
  const [step, setStep] = useState(0); // 0–4 = steps, 5 = done screen
            ...
            <>
              ...
              <div className="flex items-center justify-between mb-5">
                <div>
                  ...
                  <h2 className="text-base font-bold text-gray-900">The 5Ds</h2>
                </div>
                <button
                  ref={firstFocusRef}
                  onClick={onClose}
            ...
            <div className="text-center space-y-5 py-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2 leading-relaxed">
                  You just beat a craving using the 5Ds. Every time you resist, you weaken the habit loop.
                </p>
              </div>
